...
public class ReservationDTO {
	...
	public ReservationDTO(int gid, String packname, int ea, String id) {
		super();
		this.gid = gid;
	...
	public ReservationDTO(int gid, String packname,String out_p,String in_p,Date outdate,Date indate,int term,int price,int ea) {
		super();
		this.gid = gid;
		this.packname = packname;
		this.out_p = out_p;
